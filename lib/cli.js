...
const cli = meow(`
	...
	${chalk.blue("Commands")}
		${chalk.blueBright("npw luctst-cli start, create project structure")}
		${chalk.blueBright("npx luctst-cli update, check if files config from template/ are diferents from yours")}
`);
